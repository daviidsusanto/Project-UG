...
public class Hexa_converter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hexa_converter, container, false);
        ...
        btnConvert.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (txtHexa.length() == 0) {
                    Toast.makeText(getActivity(), "Kolom Hexa harus diisi untuk memulai Konversi", Toast.LENGTH_LONG).show();
                } else {
                    try {
                        String str0 = txtHexa.getText().toString();
                        String str1 = Integer.toString(Integer.parseInt(str0, 16), 2);
                        txtBinary.setText(String.valueOf(str1));
                        String str2 = Integer.toString(Integer.parseInt(str0, 16), 8);
                        txtOctal.setText(String.valueOf(str2));
                        String str3 = Integer.toString(Integer.parseInt(str0, 16), 10);
                        txtDecimal.setText(String.valueOf(str3));
                        return;
