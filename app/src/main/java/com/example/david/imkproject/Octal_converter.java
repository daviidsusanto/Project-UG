...
public class Octal_converter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.octal_converter, container, false);
        ...
        btnConvert.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (txtOctal.length() == 0) {
                    Toast.makeText(getActivity(), "Kolom Octal harus diisi untuk memulai Konversi", Toast.LENGTH_LONG).show();
                } else {
                    try {
                        String str0 = txtOctal.getText().toString();
                        String str1 = Integer.toString(Integer.parseInt(str0, 8), 2);
                        txtBinary.setText(String.valueOf(str1));
                        String str2 = Integer.toString(Integer.parseInt(str0, 8), 10);
                        txtDecimal.setText(String.valueOf(str2));
                        String str3 = Integer.toString(Integer.parseInt(str0, 8), 16);
